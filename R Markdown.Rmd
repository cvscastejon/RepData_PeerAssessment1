...
The data for this assignment is available at this [link](https://github.com/rdpeng/RepData_PeerAssessment1/blob/master/activity.zip): 
...
hist(totalSteps$total_steps, xlab = "Total Number of Steps")
```
...
plot(averageDaily$interval, averageDaily$average_steps, type = "l")
```
...
hist(totalStepsFilled$total_steps, xlab = "Total Number of Steps")
```
...
library(lattice)
xyplot(avg_step~interval|daytype, type = "l", data = filledTable,layout=c(1,2))
```
